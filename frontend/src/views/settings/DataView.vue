  ...
  <div class="data-view">
    ...
    <section class="setting-section">
      ...
      <div class="export-row">
        ...
        <button class="btn-primary" @click="handleExport" :disabled="exporting">
          <Icon v-if="exporting" icon="material-symbols:progress-activity" class="spin" width="18" height="18" />
    ...
    <section class="setting-section">
      ...
      <div class="textarea-wrap" :class="{ error: importError }">
        <textarea v-model="importJson" class="json-textarea" :placeholder="t('data.import.placeholder')"
      ...
      <div class="import-actions">
        ...
        <button class="btn-primary btn-warning" @click="handleImport" :disabled="importing || !importJson.trim()">
          <Icon v-if="importing" icon="material-symbols:progress-activity" class="spin" width="18" height="18" />
