  ...
  'zh-CN': {
    ...
    settings: {
      ...
      general: {
        ...
        pluginMarketDesc: '插件市场连接与安装开关',
        marketBaseUrlLabel: '市场地址',
        marketBaseUrlHint: '官方插件市场 API 基础地址，需为 HTTPS 公网地址',
        marketBaseUrlPlaceholder: 'https://example.com',
        installEnabled: '允许安装插件',
        installEnabledHint: '关闭后前端无法创建安装或更新任务',
        refetch: '重新获取',
        reset: '恢复默认',
        resetDone: '已重置为默认设置',
    ...
    pluginMarket: {
      ...
      detail: {
        ...
        readme: '插件 README',
        documentation: '插件文档',
        documentationLoading: '正在读取插件文档...',
        documentationError: '无法读取插件文档',
        documentationEmpty: '该插件暂未提供文档。',
        documentationFrameTitle: '{name} 插件文档',
        dependencies: '插件依赖',
        ...
        download: '下载',
        downloadVersion: '下载此版本安装包',
        notLatestHint: '当前选择非最新版本，可在版本历史中下载历史版本。',
        selectVersion: '选择版本',
    ...
    modelEditDialog: {
      ...
      model: {
        ...
        extraParamsDesc: '用于 API 调用时的额外配置，支持 TOML inline object 或 JSON（不含 headers/query/body 特殊键）',
        extraParamsPlaceholder: '{ tool_choice = "auto" } 或 { "tool_choice": "auto" }',
        toolChoiceAutoPreset: '填入 tool_choice = "auto"',
        httpSpecialKeysDesc: 'HTTP 层特殊键（headers/query/body）：留空表示不启用，三者均会从 extra_params 中独立透传',
        headersLabel: 'HTTP 请求头（headers）',
        headersDesc: '注入到 HTTP 请求头，键值均为字符串，如 {"X-API-Version": "2024-06"}',
        headersPlaceholder: '{"X-API-Version" = "2024-06", "X-Priority" = "high"}',
        queryLabel: 'URL 查询参数（query）',
        queryDesc: '注入到 URL 查询参数，如 {version: "2024-01-01"}',
        queryPlaceholder: '{version = "2024-01-01"}',
      ...
      log: {
        ...
        realtime: {
          ...
          selectionCount: '已选 {count} 条日志',
          copy: '复制',
          copyTitle: '复制选中日志',
          clearSelection: '取消选择',
          clearSelectionTitle: '取消所有选择',
          copySuccess: '已复制 {count} 条日志到剪贴板',
          copyFailed: '复制失败，请检查浏览器剪贴板权限',
          selectHint: '左键多选 · 右键取消 · Esc 清空 · 移动端左滑',
          swipeHint: '左滑可选中日志',
          selectAll: '全选',
          deselectAll: '取消全选',
          selectAllTitle: '全选所有日志（再次点击取消）',
        },
        history: {
          archives: 'Archives',
          filesTitle: '日志文件',
  ...
  'en-US': {
    ...
    settings: {
      ...
      general: {
        ...
        pluginMarketDesc: 'Plugin market connection and installation toggle',
        marketBaseUrlLabel: 'Market Base URL',
        marketBaseUrlHint: 'Official plugin market API base URL; must be a public HTTPS address',
        marketBaseUrlPlaceholder: 'https://example.com',
        installEnabled: 'Allow Plugin Installation',
        installEnabledHint: 'When off, the frontend cannot create install or update tasks',
        refetch: 'Reload',
    ...
    pluginMarket: {
      ...
      detail: {
        ...
        documentationLoading: 'Loading plugin documentation...',
        documentationError: 'Unable to load plugin documentation',
        documentationEmpty: 'This plugin does not provide documentation yet.',
        documentationFrameTitle: '{name} plugin documentation',
        ...
        download: 'Download',
        downloadVersion: 'Download this version package',
        notLatestHint: 'The selected version is not the latest. You can download historical versions from the version history.',
    ...
    modelEditDialog: {
      ...
      model: {
        ...
        extraParamsDesc: 'Extra API call configuration, supports TOML inline object or JSON (excluding headers/query/body special keys)',
        extraParamsPlaceholder: '{ tool_choice = "auto" } or { "tool_choice": "auto" }',
        toolChoiceAutoPreset: 'Fill tool_choice = "auto"',
        httpSpecialKeysDesc: 'HTTP-layer special keys (headers/query/body): leave empty to disable; all three are transparently passed through from extra_params',
        headersLabel: 'HTTP Headers (headers)',
        headersDesc: 'Injected into HTTP request headers; keys and values are strings, e.g. {"X-API-Version": "2024-06"}',
        headersPlaceholder: '{"X-API-Version" = "2024-06", "X-Priority" = "high"}',
        queryLabel: 'URL Query Params (query)',
        queryDesc: 'Injected into URL query params, e.g. {version: "2024-01-01"}',
        queryPlaceholder: '{version = "2024-01-01"}',
      ...
      log: {
        ...
        realtime: {
          ...
          selectionCount: '{count} log(s) selected',
          copy: 'Copy',
          copyTitle: 'Copy selected logs',
          clearSelection: 'Clear selection',
          clearSelectionTitle: 'Clear all selections',
          copySuccess: 'Copied {count} log(s) to clipboard',
          copyFailed: 'Copy failed. Please check browser clipboard permissions',
          selectHint: 'Left-click toggle · Right-click deselect · Esc clear · Mobile swipe-left',
          swipeHint: 'Swipe left to select logs',
          selectAll: 'Select All',
          deselectAll: 'Deselect All',
          selectAllTitle: 'Select all logs (click again to deselect)',
        },
        history: {
          archives: 'Archives',
